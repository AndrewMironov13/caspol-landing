...
/* Мессенджеры — все на основной номер +7 (950) 347-01-96.
   ...
   отдаёт «Chat with +7 950 347 01 96»). У MAX ссылка по номеру не работает —
   max.ru/+7… отвечает «не нашли чат по этой ссылке», нужен профильный адрес
   из приложения. Пустой url не рендерится, чтобы в эфир не ушла битая кнопка. */
